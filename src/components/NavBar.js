    ...
    <div className="top">
            <div className='logo' onClick={()=>setShow(true)}>
              <Link to="/">
                ...
                <p>Explore <span className='plus-color'>plus</span>
            ...
            <div className='search'>
                <input type='text' placeholder='Search for products' onChange={(event)=>{
        ...
        {/* {a} */}
            ...
            <a href="#" className='navlink'>Become a Seller</a>
            <a href="#" className='navlink'>More</a>
